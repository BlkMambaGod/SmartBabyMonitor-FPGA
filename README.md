...
The system measures vital signs and environmental parameters to help **prevent Sudden Infant Death Syndrome (SIDS)** and alert parents when dangerous conditions are detected.
...
4. Send real-time alerts to a mobile device (optional IoT extension).  
5. Demonstrate real-time control and synchronization on FPGA hardware.
...
- Debugging via waveform analysis and logical probe testing.
